...
function myFunction() {
    if (document.body.scrollTop > 440 || document.documentElement.scrollTop >440) {
            ...
            var navBtn1 = document.getElementsByClassName('md-nav-li')[1].getElementsByTagName('button')[0].classList.add('scroller-nav-btn');           
            var navBtn = document.getElementsByClassName('md-nav-li')[0].getElementsByTagName('button')[0].classList.remove('nav-btn');
            var navBtn1 = document.getElementsByClassName('md-nav-li')[1].getElementsByTagName('button')[0].classList.remove('nav-btn');
            ...
            var navBtn = document.getElementsByClassName('md-nav-li')[0].getElementsByTagName('button')[0].classList.add('nav-btn');
             var navBtn1 = document.getElementsByClassName('md-nav-li')[1].getElementsByTagName('button')[0].classList.add('nav-btn');
            var navBtn = document.getElementsByClassName('md-nav-li')[0].getElementsByTagName('button')[0].classList.remove('scroller-nav-btn');
             var navBtn1 = document.getElementsByClassName('md-nav-li')[1].getElementsByTagName('button')[0]    .classList.remove('scroller-nav-btn');        
